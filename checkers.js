...
function addchecker(checkercolor){
	var checker = document.createElement('div');
	document.body.appendChild(checker);
	

	if (checkercolor == 'white.png'){
		checker.innerHTML='<img id="img2" alt="white.png" src="white.png" />';
		checker.className = 'drag2 whitechecker';
	}
	else {
		checker.innerHTML='<img id="img2" alt="checkerspiece.png" src="checkerspiece.png" />';
		checker.className = 'drag2 blackchecker';
	}
}

function setupBoard() {
	addchecker('checkerspiece.png');
	addchecker('white.png');
	addchecker('checkerspiece.png');
}
